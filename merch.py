...
class Merch:
    ...
    def process_data(self):
        if not self.is_processed:
            ...
            for item in purchased:
                ...
                for product in products:
                    ...
                    if "Buy 6 Get 7" in product:
                        ...
                        parameters_str = parameters.group(1)
                        items = parameters_str.split(", ")[1:]
                        size: str = items[0].split("Size: ")[1]
                        quantity = int(items[1][-1])
                        color: str = items[2].split(": ")[1]
                        ...
                        parameters_str = parameters.group(1)
                        items = parameters_str.split(", ")[1:]
                        design: str = items[0].split("Design: ")[1]
            ...
            print("Data has been processed already")
